        ...
        <div className="flex justify-between">
          <div className="text-[#6e767d]">
            <div className="group inline-block">
              ...
              <span className="ml-1.5 text-sm sm:text-[16px]">
                @{comment?.tag}{' '}
              </span>
            </div>{' '}
            ·{' '}
            <span className="mr-0 text-sm hover:underline sm:text-[16px]">
              <Moment fromNow>{comment?.timestamp?.toDate()}</Moment>
            </span>
            <p className="mt-0.5 max-w-lg  overflow-hidden text-[15px] text-[#d9d9d9] sm:text-base">
              {comment?.comment}
            </p>
          </div>
